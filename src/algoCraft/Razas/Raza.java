...
public abstract class Raza {
	...
	public boolean crearUnidad(int minerales, int gases,
			ArrayList<Edificio> listaDeEdificios, Unidad unidadACrear) throws ExcepcionGasesInsuficientes, ExcepcionMineralesInsuficientes {
		boolean puede = false;
	...
	private boolean verificarCreacionUnidad(Unidad unidadAuxiliar,
			ArrayList<Edificio> listaDeEdificios, int minerales, int gases) throws ExcepcionGasesInsuficientes, ExcepcionMineralesInsuficientes {
